...
df = (
    df.withColumn(
        "ministere",
        when(
            lower(col("ministere")).like("%intérieur%"), "ministère de l'Intérieur"
    ...
    .withColumn(
        "ministere",
        when(
            lower(col("ministere")).like("%justice%"), "ministère de la Justice"
        ).otherwise(col("ministere")),
    )
    .withColumn(
        "ministere",
        when(
            lower(col("ministere")).like("%santé%"), "ministère de la Santé"
        ).otherwise(col("ministere")),
    )
    .withColumn(
        "ministere",
