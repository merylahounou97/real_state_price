...
docker exec -i druid-postgres psql -U druid -d metadata -c "CREATE DATABASE superset;" || echo "DB Superset OK"
docker exec -i druid-postgres psql -U druid -d metadata -c "CREATE DATABASE airflow;" || echo "DB Airflow OK"
